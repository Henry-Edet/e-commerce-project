...
const imgBackground = document.querySelector('.womenretNike1');
const shoeName = document.querySelector('.womenAtheleticNike');
const shoeWriteup = document.querySelector('.womenAthleticTalk');
...
const timer = setInterval(()=> {
    ...
    imgBackground.src = `../images/womenBack_${counter}.jpg`;
